...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 21 16:43:41 2022
...
import pandas as pd
'''
in order to avoid the error for matplotlib, we add the below 2 lines
'''
import matplotlib
...
MA_position=position.rolling(window=5).mean()
...
res.to_csv('CTA_MM_performance_result(MA Position).csv')
